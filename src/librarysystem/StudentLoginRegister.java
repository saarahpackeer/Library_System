...
public class StudentLoginRegister extends javax.swing.JFrame {
    ...
    String username, password, un, p, course, fullname;
    ...
    private void initComponents() {
        ...
        setCourse = new javax.swing.JTextField();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(setCourse)
                    .addComponent(setUsername)
                    .addComponent(setFullname)
                    .addComponent(setPassword)
                    .addComponent(reg, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(setCourse, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(reg)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(log)
    ...
    private void regMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_regMouseClicked
        ...
        Student s = new Student(fullname, username, password, "Student", course);
        s.setUsername(username);
        s.setPassword(password);
        s.setUserType("Librarian");  
        s.setCourse(course);

        // add students to local hashmap
        for(Student stu: studentdatabase) {
            usermap.put(stu.getUsername(), stu.getPassword());
        }
         
        // if the username is already taken and the account exists, do not allow registration
        if( usermap.containsKey(s.getUsername()) ) {
            JOptionPane.showMessageDialog(new JFrame(), "This user account already exists.");
        }
        // else add  the student to the database
        else  {
            try {
                a.addStudent(s, studentdatabase);
            ...
            studentdatabase.clear();
            a.loadStudents(studentdatabase);
            for(Student stud: studentdatabase) {
                usermap.put(stud.getUsername(), stud.getPassword());
            }

           JOptionPane.showMessageDialog(new JFrame(), "You have registered successfully.");
           // open logged on window
           log.setVisible(true);
        }
    ...
    private void loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginMouseClicked
        ...
        try {
            ...
            // get user input and save username for next window
            un = getUsername.getText();
            p = String.valueOf(getPassword.getPassword());
            loggedon = un;            

            // if the user exists in the db, open logged on window
            if (usermap.containsKey(un) && usermap.containsValue(p)){
                java.awt.EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        new StudentAcc(loggedon).setVisible(true);
                    }
                });
            }
            // otherwise do not allow logging on
            else
            {
   ...
   /* 
    public void save(String text, String address) throws IOException {
    FileWriter writer = null;
    
    try (Writer fileWriter = new FileWriter(address, true)) 
    {
        fileWriter.write("\n"+text);
    ...
    */
    ...
    private javax.swing.JTextField setCourse;
